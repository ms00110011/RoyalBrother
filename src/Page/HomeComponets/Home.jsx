      ...
      <div>
        <div className={style.fleet}>
          ...
          <div className={style.fleet_card_container}>
            <OurFleetCard img={HomeBike1} text={"Honda Dio"} price={"$1/Hours"}/>
            <OurFleetCard img ={HomeBike2} text={"Honda Activa 5 G"} price={"$2/Hours"}/>
            <OurFleetCard img ={HomeBike3} text={"Royal EndField 350"} price={"$3/Hours"}/>
            <OurFleetCard img ={HomeBike3} text={"Royal EndField 350"} price={"$3/Hours"}/>
          </div>
        </div>
      </div>
